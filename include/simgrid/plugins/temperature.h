...
XBT_PUBLIC double sg_host_get_surrounding_temperature(const_sg_host_t host);
XBT_PUBLIC double sg_host_get_aggregated_consumed_energy(const_sg_host_t host);
XBT_PUBLIC void sg_host_set_surrounding_temperature(const_sg_host_t host, double temperature);
XBT_PUBLIC void sg_host_update_temperatures(const_sg_host_t host);
XBT_PUBLIC void sg_host_init_master_workers(const_sg_host_t host);
...
#define MSG_host_get_surrounding_temperature(host) sg_host_get_surrounding_temperature(const_sg_host_t host);
#define MSG_host_get_aggregated_consumed_energy(host) sg_host_get_aggregated_consumed_energy(host)
#define MSG_host_set_surrounding_temperature(host, temperature) sg_host_set_surrounding_temperature(host, temperature)
#define MSG_host_update_temperatures(host) sg_host_update_temperatures(host)
#define MSG_host_init_master_workers(host) sg_host_init_master_workers(host)
